...
class HomeFragmentModule {
    ...
    @Provides
    fun provideHomeViewModel(myTaxiDao: MyTaxiDao, myTaxiListByLocationRepository: MyTaxiListByLocationRepository): HomeViewModel {
        return HomeViewModel(myTaxiDao, myTaxiListByLocationRepository)
    }
